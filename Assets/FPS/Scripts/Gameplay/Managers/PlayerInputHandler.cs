...
{
    // Extends MonoBehaviour to handle player input using the new Input System. 
    // Unity base class for getting input from the player to change the game engine state.
    public class PlayerInputHandler : MonoBehaviour
    {
        // Metadata for the class, used in the Unity Editor to provide tooltips and default values for public fields.
        // like @decorator
        [Tooltip("Sensitivity multiplier for moving the camera around - higher values mean faster movement")]
